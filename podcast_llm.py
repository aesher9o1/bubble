...
4. Keep the story under 90 seconds total
...
10. The text has to be sent to a TTS engine, don't worry about the spelling, write spelling mistakes if you think it's better for the TTS engine.
